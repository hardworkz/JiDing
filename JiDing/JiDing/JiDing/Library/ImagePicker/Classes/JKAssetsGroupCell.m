...
//        self.thumbnailView.assetsGroup = _assetsGroup;
        ...
        self.assetsCountLabel.right = self.assetsNameLabel.right + 60;
        self.assetsCountLabel.bottom = self.assetsNameLabel.bottom;
...
- (UILabel *)assetsNameLabel{
    if (!_assetsNameLabel) {
        ...
        _assetsNameLabel.textColor = [JKUtil getColor:@"686868"];
...
- (UILabel *)assetsCountLabel{
    if (!_assetsCountLabel) {
        ...
        _assetsCountLabel.textColor = [JKUtil getColor:@"a7a7a7"];
        _assetsCountLabel.font = [UIFont systemFontOfSize:15.0f];
