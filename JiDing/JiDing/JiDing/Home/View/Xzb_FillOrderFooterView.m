...
//    [self addSubview:labelB];
    ...
    NSMutableAttributedString *attriStr = [[NSMutableAttributedString alloc] initWithString:@"订单总额：¥200"];
    [attriStr setAttributes:@{NSForegroundColorAttributeName:AppDeepGrayTextColor} range:NSMakeRange(0, 5)];
    
    UILabel *countPrice = [[UILabel alloc] initWithFrame:CGRectMake(5, 10, SCREEN_Width - 10, 50)];
    countPrice.attributedText = attriStr;
    countPrice.font = [UIFont systemFontOfSize:18];
    countPrice.textColor = AppGreenTextColor;
